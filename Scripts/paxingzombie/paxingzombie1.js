...
var shootRange = 5.0;		//攻击距离
var attackRange = 3.0;		//仇恨范围
var shootAngle = 4.0;		//攻击角度
var dontComeCloserRange = 5.0;		//敌人最短距离
var delayShootTime = 0.35;			//射击时间
var pickNextWaypointDistance = 2.0;	//寻路
...
function hit(){
	ishit = 0;
	if(hitleng == 0){
	audio.PlayOneShot(behit, 0.4/ audio.volume);
